...
async def crear_alerta_y_enviar_push(db: AsyncSession, usuario_id: int, titulo: str, mensaje: str):
    nueva_alerta = NotificacionApp(usuario_id=usuario_id, titulo=titulo, mensaje=mensaje)
    db.add(nueva_alerta)
    await db.commit()
